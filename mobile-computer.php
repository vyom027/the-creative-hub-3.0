  ...
  box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
    ...
    <section class="section" id="products" style="margin-top: 30px ;">
        ...
        <?php
            ...
            $sub_category_product = null;

            if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['sub_category_id'])) {
                $sub_category_product = intval($_POST['sub_category_id']);
            }
            $sql_product = "SELECT * FROM product WHERE sub_category_id = $sub_category_product AND category_id = 1";
        ...
        <div class="container">
            ...
            ?>
                <div class="col-lg-4">
                    <div class="item">
                        <div class="thumb">
                            <a href="mobile.php?product_id=<?php echo $row['product_id']; ?>
