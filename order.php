...
if (isset($_SESSION['user_id'])) {
    ...
    $order_query = "
        SELECT 
            confirm_orders.order_date,
            confirm_orders.main_image,
            product.name,
            product.description,
            product.price
        FROM 
            confirm_orders
        JOIN 
            product ON confirm_orders.product_id = product.product_id
        WHERE 
            confirm_orders.user_id = $user_id";
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h3 class="h5 text-center flex-grow-1 text-center mb-0">Delivered Orders</h3>
                    <a href="orders.php" class="btn btn-primary ms-3">Pending Orders</a>
                </div>
